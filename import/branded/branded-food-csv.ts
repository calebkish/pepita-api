...
const inputNutrientCsvPath = path.join('import', 'data', 'supporting', 'nutrient.csv');
...
const inputFoodBrandCsvPath = path.join('import', 'data', 'branded', 'exports', 'branded_food_brand_owner.csv');
const inputFoodNutrientCsvPath = path.join('import', 'data', 'branded', 'exports', 'food_nutrient.csv');


const csvOutputFolder = path.join('import', 'data', 'branded', 'postgres-copy');
